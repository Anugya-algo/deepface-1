...
WEIGHTS_URL = (
    "https://github.com/Anugya-algo/deepface_models/releases/download/v1.0/vgg_face_weights.h5"
)
...
def load_model(
    ...
    # as described here: https://github.com/Anugya-algo/deepface/issues/944
